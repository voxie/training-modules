...
When you are done, push your code to GIT.  Please create a tag called **v1.3** with a message of 'ready for review'.  Be sure your tags are pushed to the remote repository and are visible in GitLab.
