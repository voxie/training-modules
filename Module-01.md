...
30. In the `community` repo, create a new GitLab Issue titled "Review Module 1 - Git Test" and @mention all the team leaders and the department manager in the description. For example, `@tharvey @bkuhl @kferguson please review`.
